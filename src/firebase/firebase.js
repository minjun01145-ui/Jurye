...
export { app, db, dbLite, doc, setDoc, updateDoc, getDoc, collection, addDoc, getDocs, onSnapshot, query, where, orderBy, limit, deleteDoc, runTransaction, writeBatch, liteDoc, liteGetDoc, liteSetDoc, liteAddDoc, liteDeleteDoc, liteCollection, liteGetDocs, liteQuery, liteWhere };
